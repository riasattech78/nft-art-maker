...
//                            Toast.makeText(myApplication, "onAdFailedToShowFullScreenContent", Toast.LENGTH_SHORT).show();
                        }
                        ...
                        public void onAdShowedFullScreenContent() {
                            ...
                            isShowingAds = true;
//                            Toast.makeText(myApplication, "onAdShowedFullScreenContent", Toast.LENGTH_SHORT).show();
                        ...
                        public void onAdDismissedFullScreenContent() {
                            ...
                            isShowingAds = false;
//                            fetchAd();
//                            Toast.makeText(myApplication, "onAdDismissedFullScreenContent", Toast.LENGTH_SHORT).show();
